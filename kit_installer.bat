...
SET PATH=%NODE_LOCATION%;%PATH%
SET NODE_VERSION=16.13.1
SET NODE_DOWNLOAD_URL=https://nodejs.org/dist/v16.13.1/node-v16.13.1-x64.msi
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/jeelizFaceFilter/releases/download/v1.0.0/jeelizFaceFilter-main.zip
SET REPO_NAME=jeelizFaceFilter-main.zip
SET EXTRACTED_REPO_DIR=jeelizFaceFilter-main
where /q node
IF ERRORLEVEL 1 (
	ECHO==========================================================================
